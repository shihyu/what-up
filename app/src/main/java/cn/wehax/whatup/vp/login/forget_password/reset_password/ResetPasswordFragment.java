...
public class ResetPasswordFragment extends BaseFragment {
    public final String TAG = "ResetPasswordFragment";
    ...
    protected void initView() {
        setTopBarTitle(R.string.reset_password);
        ...
        bottomBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (v.getTag() == BTN_STATUS_RESEND) {
                    presenter.requestPasswordResetSmsCode(phoneNumber);
                    return;
                }
                ...
                if (v.getTag() == BTN_STATUS_POSITIVE) {
                    ...
                    presenter.resetPasswordBySmsCode(verifyCode, password);
                    return;
                }
            }
        });
    ...
    public void moveToChooseLoginOrRegisterView() {
        Intent intent = new Intent(getActivity(), ChooseLoginOrRegisterActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP); // clear top
