...
public class SwipeListView extends ListView {
    ...
    private final int mDuration = 10;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                mCurrentItemView.findViewById(R.id.relation_user_layout).setBackgroundResource(R.drawable.relation_item_bg);
                break;
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mIsHorizontal) {
                    ...
                    if (dx < 0 && dx > -mRightViewWidth) {
                        ...
                        mCurrentItemView.findViewById(R.id.relation_user_layout).setBackgroundResource(R.drawable.relation_item_bg_n);
                    }
