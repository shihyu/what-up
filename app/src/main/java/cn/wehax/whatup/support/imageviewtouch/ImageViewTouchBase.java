...
public class ImageViewTouchBase extends ImageView implements IDisposable {
	 ...
	 * next call to the {@link #setImageBitmap(android.graphics.Bitmap, boolean, android.graphics.Matrix)} to
	 * restore the same view state of the previous {@link android.graphics.Bitmap}
	 * 
	 * @return
	 */
	 ...
	 *            old {@link android.graphics.Matrix} is used to display the new bitmap
	 * @see #setImageBitmap(android.graphics.Bitmap)
	 */
	...
	/**
	 * Similar to {@link #setImageBitmap(android.graphics.Bitmap, boolean)} but an optional view
	 * {@link android.graphics.Matrix} can be passed to determine the new bitmap view matrix.<br />
	 ...
	 * @param reset
	 * @param matrix
	 *            - the {@link android.graphics.Matrix} to be used to display the new bitmap
	 * 
	 * @see #setImageBitmap(android.graphics.Bitmap, boolean)
	 * @see #setImageBitmap(android.graphics.Bitmap)
	 ...
	 * 
	 * @see #setImageBitmap(android.graphics.Bitmap, boolean, android.graphics.Matrix)
	 */
	public void setImageBitmap(final Bitmap bitmap, final boolean reset,
